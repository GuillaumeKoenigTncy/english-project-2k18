        ...
        <main role="main"> 
            ...
            <div class="container">
                ...
                for($i = 2; $i < count($files); ++$i) {
                    echo '<a href="/projet/spequizz.php?name='. str_replace ( ".json" , "" , $files[$i] ) .'&category=spelling" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">'. str_replace ( ".json" , "" , $files[$i] ) .'</a>';
                }
                ?>
            </div> <!-- /container -->
